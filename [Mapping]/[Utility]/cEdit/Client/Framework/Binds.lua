...
functions['Toggle Freecam'] = function ()
	...
	if Cached.freeCam then
		...
		setElementData(localPlayer,'Camera',true)
		setElementData(localPlayer,'Freecam',true)
	else
		...
		setElementData(localPlayer,'Freecam',false)
	end
end
...
functions['Change Freecam Speed'] = function ()
	...
	functions.sendNotification('Freecam speed set to '..lSecession.variables['Speed'][1]..'.')
end
