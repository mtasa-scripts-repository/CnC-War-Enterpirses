...
levelSettings = {}
levelSettings['Low'] = {}
levelSettings['Low']['blurFactor'] = 0.1
levelSettings['Low']['brightBlurAdd'] = 0.2
levelSettings['Low']['fFarBlurCurve'] = 8
levelSettings['Low']['fManualFocusDepth'] = 0.02

levelSettings['Medium'] = {}
levelSettings['Medium']['blurFactor'] = 0.6
levelSettings['Medium']['brightBlurAdd'] = 0.5
levelSettings['Medium']['fFarBlurCurve'] = 5
levelSettings['Medium']['fManualFocusDepth'] = 0.05

levelSettings['High'] = {}
levelSettings['High']['blurFactor'] = 1
levelSettings['High']['brightBlurAdd'] = 0.9
levelSettings['High']['fFarBlurCurve'] = 4
levelSettings['High']['fManualFocusDepth'] = 0.05

levelSettings['Cinematic'] = {}
levelSettings['Cinematic']['blurFactor'] = 3
levelSettings['Cinematic']['brightBlurAdd'] = 0.9
levelSettings['Cinematic']['fFarBlurCurve'] = 4
levelSettings['Cinematic']['fManualFocusDepth'] = 0.08

function setEffectVariables(level)
    local v = Settings.var
    -- Blur
    v.blurFactor = levelSettings[level or 'Medium']['blurFactor'] or 0.6 -- blur ammount
    v.brightBlur = true -- should darker pixel get less blur
    v.brightBlurAdd = levelSettings[level or 'Medium']['brightBlurAdd'] or 0.5 -- standard blur is brightBlur true
	-- Depth 
	v.fManualFocus = true
	v.fNearBlurCurve = 12.0 -- [0.4 to X] Power of blur of closer-than-focus areas.
	v.fFarBlurCurve = levelSettings[level or 'Medium']['fFarBlurCurve'] or 5 -- [0.4 to X] Elementary, my dear Watson: Blur power of areas behind focus plane.
	v.fManualFocusDepth = levelSettings[level or 'Medium']['fManualFocusDepth'] or 0.05 -- [0.0 to 1.0] Manual focus depth. 0.0 means camera is focus plane, 1.0 means sky is focus plane.
end
...
addEvent ( "DOF", true )
addEventHandler ( "DOF", root, changeSetting )
