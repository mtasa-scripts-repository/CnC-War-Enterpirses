...
float4 PixelShaderFunction(PSInput PS) : COLOR0
{
    ...
    // apply attenuation
    finalColor.rgb *= saturate(NdotL * fAttenuation); 
...
// Techniques
//--------------------------------------------------------------------------------------
technique dxDrawMaterial3DPointLight
{
  pass P0
  {
    ZEnable = true;
...
technique dxDrawMaterial3DPointLight_fallback
{
  pass P0
  {
    ZEnable = true;
