// 
// file: material3D_pointLight_LOD.fx
// version: v1.6
// author: Ren712
//
...
PSInput VertexShaderFunction(VSInput VS)
{
    ...
    VS.Position.xyz *= length(2 * sLightAttenuation);	
...
// Techniques
//--------------------------------------------------------------------------------------
technique dxDrawMaterial3DPointLight_LOD
{
  pass P0
  {
    ZEnable = false;
...
technique dxDrawMaterial3DPointLight_LOD_fallback
{
  pass P0
  {
    ZEnable = true;
