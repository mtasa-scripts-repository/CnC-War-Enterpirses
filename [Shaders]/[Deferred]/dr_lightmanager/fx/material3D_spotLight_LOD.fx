// 
// file: material3D_spotLight_LOD.fx
// version: v1.6
// author: Ren712
//
...
PSInput VertexShaderFunction(VSInput VS)
{
    ...
    VS.Position.xz *= tan(sLightPhi) * (2 * sLightAttenuation);		
...
// Techniques
//--------------------------------------------------------------------------------------
technique dxDrawMaterial3DSpotLight_LOD
{
  pass P0
  {
    ZEnable = false;
...
technique dxDrawMaterial3DSpotLight_LOD_fallback
{
  pass P0
  {
    ZEnable = true;
