...
function setEffectVariables()
    ...
    -- Blur
    v.blurFactor = 5 -- blur ammount
    v.brightBlur = true -- should darker pixel get less blur
    v.brightBlurAdd = 0.5 -- standard blur is brightBlur true
	-- Depth 
	v.fManualFocus = true
	v.fNearBlurCurve = 10.0 -- [0.4 to X] Power of blur of closer-than-focus areas.
	v.fFarBlurCurve = 3 -- [0.4 to X] Elementary, my dear Watson: Blur power of areas behind focus plane.
